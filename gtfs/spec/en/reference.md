...
|  Field Name | Type | Presence | Description |
|  ------ | ------ | ------ | ------ |
|  `from_stop_id` | Foreign ID referencing `stops.stop_id` | **Conditionally Required** | Identifies a stop or station where a connection between routes begins. If this field refers to a station, the transfer rule applies to all its child stops.  <br><br>Conditionally Required:<br>- **Required** for `transfer_types` `0`, `1`, `2` and `3`. <br>- Optional `transfer_types` `4` and `5`<br><br>Refering to a station is forbidden for `transfer_types` `4` and `5`.|
|  `to_stop_id` | Foreign ID referencing `stops.stop_id` | **Conditionally Required** | Identifies a stop or station where a connection between routes ends. If this field refers to a station, the transfer rule applies to all child stops. <br><br>Conditionally Required:<br>- **Required** for `transfer_types` `0`, `1`, `2` and `3`. <br>- Optional `transfer_types` `4` and `5`<br><br>Refering to a station is forbidden for `transfer_types` `4` and `5`.|
